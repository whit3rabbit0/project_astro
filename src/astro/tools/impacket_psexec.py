"""ImpacketPsexecTool — Remote command execution via SMB/PsExec."""
import re
...
class ImpacketPsexecTool(BaseTool):
    name = "impacket-psexec"
    description = "Remote command execution via SMB/PsExec"
    ...
    def build_command(self, params: dict[str, Any]) -> list[str]:
        ...
        cmd = ["impacket-psexec", *auth_parts, params["command"]]
